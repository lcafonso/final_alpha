...
<div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="<?php echo e(route('tools')); ?>" class="list-group-item list-group-item-action bg-light">
            <span class="fas fa-tools fa-lg fa-fw"></span>
            <span style="margin-left: 25px;">Ferramentas</span>
        </a>
        <a href="<?php echo e(route('events')); ?>" class="list-group-item list-group-item-action bg-light">
            <span class="fas fa-tasks  fa-lg fa-fw"></span>
            <span style="margin-left: 25px;">Eventos</span>
        </a>
        <a href="<?php echo e(route('status')); ?>" class="list-group-item list-group-item-action bg-light">
...
<!-- /#sidebar-wrapper -->
<?php /**PATH D:\laragon\www\final_alpha\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>