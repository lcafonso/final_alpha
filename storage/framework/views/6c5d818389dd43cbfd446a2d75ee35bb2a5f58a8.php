    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo e(route('admin.index')); ?>">Dashboard <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
...
</nav><?php /**PATH D:\laragon\www\final_alpha\resources\views/admin/partials/nav.blade.php ENDPATH**/ ?>