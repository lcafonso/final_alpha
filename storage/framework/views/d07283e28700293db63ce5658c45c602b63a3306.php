...
<?php else: ?>
    ...
    <?php if($pageData['smenu'] != 21): ?>
        <header class="masthead" style="background-image: url(<?php echo e(asset( $pageData['bg'] )); ?> ); max-height: 350px; )">
    <?php else: ?>
        <header class="masthead" style="top:-60px;background-image: url(<?php echo e(asset( $pageData['bg'] )); ?> ); max-height: 350px; )">
    <?php endif; ?>
...
<?php /**PATH /var/www/digitalandscape.esa.ipb.pt/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>