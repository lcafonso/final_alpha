...
<?php $__env->startSection('content'); ?>
    ...
    <div id="tools" class="offset">
        ...
        <div class="col-lg-5 offset text-center">
            ...
            <div class="heading-underline"></div>
            <p>Com a ajuda da ferramenta de comparação, podemos ver as fotografias com repetição, sobrepondo uma a outra, assim podemos analizar a imagem principal e a foto repetida com mais detalhes.</p>
