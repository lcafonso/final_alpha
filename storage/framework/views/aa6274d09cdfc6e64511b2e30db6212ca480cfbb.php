...
<div class="container mt-2">
    ...
    <?php elseif($metodo == 'repost'): ?>
        <a href="<?php echo e(url()->previous()); ?>">Publicações></a>
        <div class="row">
            <div class="col-md-2">
                <div class="img-thumbnail" style="width: 150px;height: 150px">
                    <img  src="<?php echo e($post->file); ?>" style="width: 100%;height: auto" alt="">
                </div>
            </div>
            <div class="col">
                <h3 class="title">Repetição da publicação <?php echo e($post->id); ?> - <?php echo e($post->name); ?> </h3>
                <h3 class="title">Autor da Publicação Original: <?php echo e($post->user->name); ?></h3>
                <p>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <?php echo Form::textarea('excerpt', (!empty($post->excerpt)?'Texto original: "'.$post->excerpt.'"':null), ['class' => 'form-control', 'rows' => '2']); ?>
        ...
        <div class="col">
            ...
            <div class="form-group">
                ...
                <?php echo Form::textarea('body',(!empty($post->body)?'Texto original: '.$post->body:null), ['class' => 'form-control', 'id' => 'body', 'name' => 'body' ]); ?>
    ...
    <br>
</div><?php /**PATH /var/www/digitalandscape.esa.ipb.pt/resources/views/admin/posts/partials/form2.blade.php ENDPATH**/ ?>