...
@section('content')
    ...
    <div class="case-study-gallery">
        ...
        @foreach($posts as $post)
            <div class="case-study" style="background-image: url('{{$post->file}}');">
                <figure>
                    <img class="case-study__img" src="{{ asset('img/logo_b1.png')  }}" style="height: 100px; width: auto" alt="" />
                </figure>
                <div class="case-study__overlay">
                    <h2 class="case-study__title">{{ $post->name }}</h2>

                    <div class="row">
                        <a class="case-study__link" href="{{ route('adminposts.show', $post->id) }}">
                            <i class="far fa-eye"></i>
                        </a>
                        {!! Form::open(['route' => ['adminposts.destroy', $post->id], 'method' => 'DELETE']) !!}
                            <button class="case-study__link  btn-outline-danger" style="width: 250%;background-color: Transparent;">
                                <i class="far fa-trash-alt"></i>
                            </button>
                        {!! Form::close() !!}
                        <a class="case-study__link" href="{{ route('adminposts.edit', $post->id) }}">
