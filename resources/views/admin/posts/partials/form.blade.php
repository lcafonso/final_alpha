    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <div id="image-holder" style="width: auto;height: 200px;  background-color: white">
                    @if($metodo == 'edit')
                        <img  class="center" src="{{asset($post->file)}}" style="width: auto;height: 200px; display: block; margin-left: auto; margin-right: auto;">
                    @endif
                </div>
        ...
        <div class="col">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('body', (!empty($post->body)?$post->body:null), ['class' => 'form-control', 'id' => 'body', 'name' => 'body' ]) !!}
            </div>
